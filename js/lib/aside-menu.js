...
var module = angular.module('asideModule', [])
                ...
                elem.bind('click', function () {
                    ...
                    if (scope.targetMenu.open) {
                        ...
                        if (scope.targetMenu.isBackdrop == "true") {
                            ...
                            var myEl = angular.element( document.querySelector( '#backdrop' ) );
                            myEl.addClass('aside-back-drop in');
                            ...
                            myEl.bind('click', function () {
                                ...
                                scope.$emit('getMenuState', false);
                                myEl.removeClass('aside-back-drop in');
    ...
    .directive('closeAsideMenu', function (e) {
        'use strict';
